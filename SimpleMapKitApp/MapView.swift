...
//  Returns the icon of the pin depending on its type
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            region = MKCoordinateRegion(center: centerOn, span: span)
        }
...
struct MapView_Previews: PreviewProvider {
    static var previews: some View {
        MapView(centerCoordinate: .constant(CLLocationCoordinate2D(latitude: 44.49, longitude: 11.32)), locations: [Location]())
    }
}
